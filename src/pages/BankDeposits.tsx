  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const bankDeposits = mockTransactions.filter(t => t.type === 'Bank Deposits');
        setTransactions(bankDeposits);
      } catch (error) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-black flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-yellow-600">Loading bank deposits data...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-black">
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="mb-6">
          <h2 className="text-3xl font-bold text-yellow-600 mb-2">Bank Deposits</h2>
          <p className="text-gray-700">Analysis of all bank deposit transactions</p>
        </div>
