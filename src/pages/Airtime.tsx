  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const airtimeTransactions = mockTransactions.filter(t => t.type === 'Airtime Purchase');
        setTransactions(airtimeTransactions);
      } catch (error) {
      ...
      <div className="min-h-screen" style={{ backgroundColor: '#FDD835' }}>
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <p className="text-black font-semibold">Loading airtime data...</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#FDD835' }}>
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="mb-6">
          <h2 className="text-3xl font-bold text-black mb-2">Airtime Purchases</h2>
          <p className="text-gray-800">Analysis of all airtime purchase transactions</p>
        </div>
